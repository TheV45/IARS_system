                ...
                <div class="card-body">
                    <form method="POST" action='/register/teacher' >
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                        1<input type="radio" name="gender" value="" onchange = "enable1()"> 
                                        2<input type="radio" name="gender" value="" onchange = "enable2()"> 
                                </div>
                            </div>
                        <div class="form-group row">
                                <div class="col-md-6">
                                    <select id="class_1" type="text" class="form-control" name="class_1" required disabled>
